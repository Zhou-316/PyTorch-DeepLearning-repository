...
| `MNIST training2.py` | CNN-based MNIST classifier using Adam. |
...
- Run any script directly, e.g.:
  ...
  - `python "MNIST training.py"` or `python "MNIST training2.py"` to train MNIST models (downloads data to `./data`).
